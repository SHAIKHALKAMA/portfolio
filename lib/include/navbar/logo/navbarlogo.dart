    ...
    return SizedBox(
      ...
      child: Row(
        children: [
          ...
          Text('Shaikh Alkama', style: TextStyle(color: Colors.blueAccent,fontSize: 20, fontFamily: 'Agustina'),),
    ...
    return SizedBox(
      ...
      child: Row(
          children: [
            ...
            Text('Shaikh Alkama', style: TextStyle(color: Colors.blueAccent,fontSize: 30, fontFamily: 'Agustina'),),

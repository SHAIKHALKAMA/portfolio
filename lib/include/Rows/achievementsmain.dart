    ...
    return Container(
      ...
      child: Column(
        ...
        child: Column(
          ...
          children: [
              Image.network('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuZFbmyoGbcPjanQOsLtXPVS1Za9tCJWAgNg&s',width: 250, height: 175,),
              Text('Way 2 Cure',style: TextStyle(fontSize: 30, fontWeight: FontWeight.w700),textAlign: TextAlign.center,),
              InkWell(
                onTap: () {
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
              Image.network('https://play-lh.googleusercontent.com/HBXBmdVcLT6Ro6bLkAZyDVTfplhDnTHTy5XRwI0Q-iMCm83OK695nUl9QrMpT-VIuokP',width: 250, height: 175,),
              Text('Way 2 Cure Jobs',style: TextStyle(fontSize: 30, fontWeight: FontWeight.w700),textAlign: TextAlign.center,),
              InkWell(
                onTap: () {
                   js.context.callMethod("open", ["https://play.google.com/store/apps/details?id=com.naveenjujaray.walls"]);
                },
    ...
    return SingleChildScrollView(
        ...
        child: Column(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
                  Image.network('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuZFbmyoGbcPjanQOsLtXPVS1Za9tCJWAgNg&s',width: 200, height: 125,),
                  Text('Way 2 Cure',style: TextStyle(fontSize: 30, fontWeight: FontWeight.w700),textAlign: TextAlign.center,),
                  InkWell(
                    onTap: () {
                       js.context.callMethod("open", ["https://play.google.com/store/apps/details?id=com.naveenjujaray.walls"]);
